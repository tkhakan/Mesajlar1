...
public class GelenMesaj extends ActionBarActivity {
	...
	private void fetchInboxMessages() {
		if (listInboxMessages == null) {
			showProgressDialog("Gelen Mesajlar...");
	...
	static class CustomHandler extends Handler {
		private final WeakReference<GelenMesaj> activityHolder;

		CustomHandler(GelenMesaj inboxListActivity) {
			activityHolder = new WeakReference<GelenMesaj>(inboxListActivity);
		}

		@Override
		public void handleMessage(android.os.Message msg) {

			GelenMesaj inboxListActivity = activityHolder.get();
