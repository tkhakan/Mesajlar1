...
public class MessageListAdapter extends ArrayAdapter<Message> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView1 == null) {
			...
			holder.messageDat = (TextView) convertView1.findViewById(R.id.txt_messageDate);
		...
		holder.messageDat.setText(message.messageDate);
	...
	private class Holder {
		public TextView messageTo, messageContent,messageDat;
	}
